...
export function ModalDesignationDetails({
  open = false,
  setOpen,
  save,
  designation,
  ...
  useEffect(() => {
    if (open) {
      ...
      if (designation) {
        ...
        setFormData({ designation: "" }); // Reset when adding a new designation
      }
      setError("");
    }
  }, [designation, open]); // Added `open` dependency
  ...
  const handleChange = (e) => {
    ...
    if (value === "" || pattern.test(value)) {
      ...
      setError("Designation may only contain letters, spaces, /, &, (, and ). It must start with a letter.");
    }
  };
  ...
  if (error || !formData.designation.trim()) {
    setError("Please enter a valid designation name.");
    return;
  }
...
ModalDesignationDetails.propTypes = {
