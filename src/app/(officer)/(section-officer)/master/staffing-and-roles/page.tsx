...
const StaffingAndRoles = () => {
  return (
    <>
                  ...
                  <ServicesCard
                      title="Cadre"
                      imageSrc="/images/services/cadre.svg"
                      links={[]}
                      navigateTo="/master-controls/cadre"
                    
                    />
                    <ServicesCard
                      title="Designation"
                      imageSrc="/images/services/designation.svg"
                      links={[]}
                      navigateTo="/master-controls/designation"
                    
                    />
                    {/* <ServicesCard
                      title="Role"
                      imageSrc="/images/services/role.svg"
                      links={[]}
                      navigateTo="/master-controls/role"
                      
                    /> */}
                    <ServicesCard
                      title="Posting Type"
                      imageSrc="/images/services/posting-type.svg"
                      links={[]}
                      navigateTo="/master-controls/posting-type"
