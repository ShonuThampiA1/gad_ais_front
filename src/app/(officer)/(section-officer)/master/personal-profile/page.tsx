...
const PersonalProfile = () => {
  return (
    <>
                  ...
                  <ServicesCard
                      title="Gender"
                      imageSrc="/images/services/gender.svg"
                      links={[]}
                      navigateTo="/master-controls/gender"
                    
                    />
                    <ServicesCard
                      title="Disability"
                      imageSrc="/images/services/disability.svg"
                      links={[]}
                      navigateTo="/master-controls/disability"
                    
                    />
                    <ServicesCard
                      title="Language"
                      imageSrc="/images/services/language.svg"
                      links={[]}
                      navigateTo="/master-controls/language"
                      
                    />
                    <ServicesCard
                      title="Qualification"
                      imageSrc="/images/services/qualification.svg"
                      links={[]}
                      navigateTo="/master-controls/qualification"
                    ...
                    <ServicesCard
                      ...
                      links={[]}
                      navigateTo="/master-controls/division"
                    ...
                    <ServicesCard
                      ...
                      imageSrc="/images/services/other.svg"
                      links={[]}
                      navigateTo="/master-controls/category"
