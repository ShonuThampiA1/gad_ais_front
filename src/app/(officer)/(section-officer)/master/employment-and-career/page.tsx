...
import { PlusIcon, XMarkIcon, ChevronRightIcon } from '@heroicons/react/20/solid'; // Added ArrowRightIcon
...
const EmployemntAndCareer = () => {
  return (
    <>
                  ...
                  {/* Employemnt And Career */}
                  <ServicesCard
                      title="Grade"
                      imageSrc="/images/services/grade.svg"
                      links={[]}
                      navigateTo="/master-controls/grade"
                    />
                    <ServicesCard
                      title="Level"
                      imageSrc="/images/services/level.svg"
                      links={[]}
                      navigateTo="/master-controls/level"
                    />
                    <ServicesCard
                      title="Recruitment"
                      imageSrc="/images/services/recruitment.svg"
                      links={[]}
                      navigateTo="/master-controls/recruitment"
                    />
                    <ServicesCard
                      title="Retirement"
                      imageSrc="/images/services/retirement.svg"
                      links={[]}
                      navigateTo="/master-controls/retirement"
                    />
                    <ServicesCard
                      title="Tenure"
                      imageSrc="/images/services/tenure.svg"
                      links={[]}
                      navigateTo="/master-controls/tenure"
                    />
                    <ServicesCard
                      title="Training Type"
                      imageSrc="/images/services/training.svg"
                      links={[]}
                      navigateTo="/master-controls/training-type"
                    />
                    {/* Employemnt And Career */}
  </>
  );
...
export default EmployemntAndCareer;
