...
// import { ModalForeignTrainingDetails } from '../modal/foreign-training-details'

//   export function ForeignTrainingDetails() {
...
//               <div>
//                 <h3 className="text-base/7 font-semibold text-gray-900">Foreign Training Details Details</h3>
//                 <p className="max-w-2xl text-sm/6 text-gray-500">Foreign Training details of Officer.</p>
//               </div>
...
//                 </button>
//                 <ModalForeignTrainingDetails open={isModalOpen} setOpen={setModalOpen} />
...
//                   <dt className="text-sm/6 font-medium text-gray-900">Foreign Training Details Details</dt>
