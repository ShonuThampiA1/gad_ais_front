...
// import { ModalMidCareerTrainingDetails } from '../modal/mid-career-training-details'

//   export function MidCareerTrainingDetails() {
...
//               <div>
//                 <h3 className="text-base/7 font-semibold text-gray-900">Mid Career Training Details Details</h3>
//                 <p className="max-w-2xl text-sm/6 text-gray-500">Mid Career Training details of Officer.</p>
//               </div>
...
//                 </button>
//                 <ModalMidCareerTrainingDetails open={isModalOpen} setOpen={setModalOpen} />
...
//                   <dt className="text-sm/6 font-medium text-gray-900">Mid Career Training Details Details</dt>
