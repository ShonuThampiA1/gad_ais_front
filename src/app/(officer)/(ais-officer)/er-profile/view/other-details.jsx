...
// import { ModalOtherDetails } from '../modal/other-details'
...
//               <div>
//                 <h3 className="text-base/7 font-semibold text-gray-900">Other Details</h3>
//                 <p className="max-w-2xl text-sm/6 text-gray-500">Other Details of Officer.</p>
//               </div>
...
//                 </button>
//                 <ModalOtherDetails open={isModalOpen} setOpen={setModalOpen} />
...
//                   <dt className="text-sm/6 font-medium text-gray-900">Other Details</dt>
