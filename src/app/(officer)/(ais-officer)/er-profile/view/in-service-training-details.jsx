...
// import { ModalInServiceTrainingDetails } from '../modal/in-service-training-details'

//   export function InServiceTrainingDetails() {
...
//               <div>
//                 <h3 className="text-base/7 font-semibold text-gray-900">In Service Training Details Details</h3>
//                 <p className="max-w-2xl text-sm/6 text-gray-500">In Service Training details of Officer.</p>
//               </div>
...
//                 </button>
//                 <ModalInServiceTrainingDetails open={isModalOpen} setOpen={setModalOpen} />
...
//                   <dt className="text-sm/6 font-medium text-gray-900">In Service Training Details Details</dt>
