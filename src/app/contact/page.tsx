      ...
      <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 rounded-2xl p-8 sm:p-12">
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
            <p>
              For any queries, support requests, or concerns regarding this User Agreement or the KARMASRI Portal, please contact
            </p>
            <div className="mt-6 bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg border border-gray-100 dark:border-gray-600">
               <h3 className="font-semibold text-lg text-gray-900 dark:text-white mb-2">General Administration Department</h3>
               <p>2nd Floor, North Block</p>
               <p>Secretariat, Statue</p>
            ...
            <div className="mt-6 bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg border border-gray-100 dark:border-gray-600">
               <h3 className="font-semibold text-lg text-gray-900 dark:text-white mb-2">Working Hours</h3>
               <p>Monday - Saturday - 10am to 5pm</p>
               <p>2nd Saturday - Closed</p>
               <p>Sunday - Closed</p><br></br>
               <p>Email : secy.gad@kerala.gov.in</p>
               {/* <div className="mt-4">
                 <p><strong>Email:</strong> support@karmasri.kerala.gov.in</p>
                 <p><strong>Phone:</strong> 0471-XXXXXXX</p>
               </div> */}
